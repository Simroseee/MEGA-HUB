...
spawn(function()
    ...
    local HminhLib =loadstring(game:HttpGet("https://raw.githubusercontent.com/Simroseee/HMinh-stella/main/HMinh%20stella.lua")))()
local Window = OrionLib:MakeWindow({Name = "HMinh Tiny", HidePremium = false, IntroText = "Minh Library", SaveConfig = true, ConfigFolder = "Min Gaming Hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin",
    Icon = "rbxassetid://33576520",
    PremiumOnly = false
})
